      ...
      showdown: [
        {
          ...
          a: 'EXCEPT → one option is factually not a member of the category',
          b: 'LEAST → one option is least supported by evidence/logic in context',
          better: 'B',
          why: 'Both mean "find the outlier" but EXCEPT = categorical exclusion; LEAST = weakest evidence link. Knowing the difference prevents misapplying the strategy.',
        },
        {
          conceptId: 'fl3-bb-ns-sd2',
          scenario: 'When stuck on a NOT/EXCEPT question, which approach is more reliable?',
          a: 'Eliminate the three that are clearly true/correct; what remains is the answer',
          b: 'Scan for the choice that sounds least scientific or most extreme',
          better: 'A',
          why: 'Elimination by confirming three positives is systematic and accurate. "Sounds extreme" is a heuristic that fails on MCAT passages with counterintuitive findings.',
        },
      ],
    },
      ...
      showdown: [
        {
          ...
          a: 'More force generated because ATP hydrolysis drives cross-bridge attachment',
          b: 'More power generated because higher ATPase → faster shortening velocity → more power at same force',
          better: 'B',
          why: 'Diameter determines force. ATPase rate determines velocity. Power = Force × velocity, so higher ATPase → higher power, not more force.',
        },
        {
          conceptId: 'fl3-bb-dc-sd2',
          scenario: 'Effect of HDAC inhibitor on gene expression',
          a: 'Transcription increases — inhibiting HDAC keeps acetyl groups on histones → open chromatin',
          b: 'Transcription decreases — inhibiting HDAC prevents chromatin condensation needed for expression',
          better: 'A',
          why: 'Acetylated histones = open chromatin = transcription ON. HDAC removes acetyl, so inhibiting HDAC preserves acetylation → more open chromatin → more transcription.',
        },
      ],
    },
      ...
      showdown: [
        {
          ...
          a: 'SDH produces succinate from succinyl-CoA (succinate is its output)',
          b: 'SDH consumes succinate, converting it to fumarate (succinate is its substrate)',
          better: 'B',
          why: 'In the TCA cycle: succinyl-CoA → succinate (succinyl-CoA synthetase), then succinate → fumarate (SDH = succinate dehydrogenase). SDH is the consumer of succinate.',
        },
        {
          conceptId: 'fl3-bb-da-2',
          scenario: 'Succinyl-CoA synthetase: what does it produce?',
          a: 'Succinyl-CoA synthetase produces succinyl-CoA from succinate',
          b: 'Succinyl-CoA synthetase produces succinate from succinyl-CoA',
          better: 'B',
          why: 'Succinyl-CoA SYNTHETASE sounds like it makes succinyl-CoA, but as a TCA enzyme it converts succinyl-CoA → succinate + GTP. It produces succinate.',
        },
        {
          conceptId: 'fl3-bb-da-3',
          scenario: 'X-inactivation: when an extra X chromosome is present, what happens to it?',
          a: 'The extra X is duplicated to ensure dosage balance',
          b: 'The extra X is inactivated (Barr body formed) to achieve dosage compensation',
          better: 'B',
          why: 'Dosage compensation = silence the extras. One X stays active; every additional X forms a Barr body. 46,XX → 1 active, 0 Barr bodies. 47,XXX → 1 active, 2 Barr bodies.',
        },
        {
          conceptId: 'fl3-bb-da-4',
          scenario: 'Blood Ca²⁺ is too HIGH. How do bone cells respond?',
          a: '↑ osteoclast activity to resorb bone and raise Ca further',
          b: '↓ osteoclast + ↑ osteoblast to deposit Ca into bone and lower serum Ca',
          better: 'B',
          why: 'Osteoclasts CRUSH bone (release Ca). Osteoblasts BUILD bone (store Ca). To lower serum Ca: crush less, build more.',
        },
        {
          conceptId: 'fl3-bb-da-5',
          scenario: 'SERT (serotonin transporter) is blocked. Net effect on synaptic serotonin?',
          a: 'Synaptic serotonin decreases — SERT normally releases serotonin into the synapse',
          b: 'Synaptic serotonin increases — SERT normally clears serotonin; blocking it lets serotonin accumulate',
          better: 'B',
          why: 'SERT is a REUPTAKE transporter: it pulls serotonin BACK into the presynaptic terminal. Block it → serotonin stays in synapse longer → ↑ concentration.',
        },
        {
          conceptId: 'fl3-bb-da-6',
          scenario: 'Osmotic pressure and solute concentration: which direction?',
          a: 'Higher solute concentration → lower osmotic pressure',
          b: 'Higher solute concentration → higher osmotic pressure (π = iMRT)',
          better: 'B',
          why: 'π = iMRT. π is directly proportional to M. More solute = more particles = more osmotic pressure. The relationship is direct, not inverse.',
        },
        {
          conceptId: 'fl3-bb-da-7',
          scenario: 'Intestinal villi: absorption surface vs propulsion',
          a: 'Villi primarily drive peristalsis and propel luminal contents',
          b: 'Villi primarily expand absorptive surface area; propulsion is driven by smooth muscle in the muscularis',
          better: 'B',
          why: 'Villi = finger-like projections that maximize surface area for absorption. Movement = circular and longitudinal smooth muscle layers in the muscularis externa.',
        },
        {
          conceptId: 'fl3-bb-da-8',
          scenario: 'Work (W = F·d) vs power (P = W/t) when only ATPase rate differs',
          a: 'Higher ATPase rate increases force and therefore increases work',
          b: 'Higher ATPase rate increases cross-bridge cycling speed → higher velocity → more power, not more force',
          better: 'B',
          why: 'Force is set by fiber diameter (# parallel sarcomeres). ATPase rate sets velocity. Work = F × d is unchanged if the load and displacement are the same; power increases because the same work is done faster.',
        },
      ],
      scenarioDrop: [],
    },
