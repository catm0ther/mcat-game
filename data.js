...
const SECTIONS = [
  {
    ...
    clusterIds: [
      ...
      'research-stats',
      'fl3-ps-sensory-perception',
      'fl3-ps-brain-imaging',
      'fl3-ps-group-influence',
      'fl3-ps-cohort-period-age',
      'fl3-ps-manifest-latent',
      'fl3-ps-direction-check',
      'fl3-ps-evidence-evaluation',
      'fl3-ps-figure-interpretation',
    ],
  },
  {
    id: 'bio-biochem',
    ...
    clusterIds: [
      ...
      'strategy-lab-bio',
      'fl3-nucleotides',
      'fl3-amino-acid-groups',
      'fl3-bb-negative-stems',
      'fl3-bb-direction-check',
      'fl3-bb-direction-anchors',
      'fl3-bb-purines-pyrimidines',
      'fl3-bb-endocrine-axes',
      'fl3-bb-enzyme-classes-bb',
      'fl3-bb-electron-carriers',
      'fl3-bb-etc-pathway',
      'fl3-bb-amino-acids',
      'fl3-bb-metabolism-map',
      'fl3-bb-physiology',
      'fl3-bb-genetics',
      'fl3-bb-figure-reasoning',
      'fl3-bb-passage-mechanism',
    ],
  },
  {
    id: 'chem-phys',
    ...
    clusterIds: [
      ...
      'calc-lab',
      'fl3-vsepr-geometry',
      'fl3-property-measurement',
      'fl3-activation-energy',
      'fl3-electron-config',
      'fl3-reaction-type',
      'fl3-enzyme-classification',
      'fl3-periodic-groups',
      'fl3-calc-stoichiometry',
      'fl3-calc-passage-values',
      'fl3-calc-inverse',
      'fl3-nucleotides',
      'fl3-amino-acid-groups',
      'fl3-biomolecule-skeletons',
      'fl3-exchangeable-protons',
      'fl3-buffer-behavior',
    ],
  },
];
